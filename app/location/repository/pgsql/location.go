...
func NewPgsqlLocationRepository(db *sql.DB) model.LocationRepository {
...
const getPing = `SELECT * FROM locations WHERE username = $1 ORDER BY created_at DESC LIMIT 1`
